...
#     set_dad
    ...
    #                     dad = User.objects.get(code=a)
    #                     if dad.level >= 1:
    #                         dad.bonuscoin += dad.bonus * i.total_deal
    #                         dad.save()
    #                         if dad.referrer_temporary is not None:
    #                             ax=User.objects.get(code=dad.referrer_temporary)
    #                             if ax.level==dad.level:
    #                                 k=2
    #                             a = dad.referrer_temporary
    #                         else:
    #                             k = 2
    #                     if dad.level==0:
    #                         if dad.referrer_temporary is not None:
    ...
    #                 if i.referrer_temporary is not None:
    #                     dad = User.objects.get(code=a)
    #                     if dad.level > i.level:
    #                         dad.bonuscoin += (dad.bonus - i.bonus) * i.total_deal
    #                         dad.save()
    #                         if dad.referrer_temporary is not None:
    #                             ax = User.objects.get(code=dad.referrer_temporary)
    #                             if ax.level == dad.level:
    ...
    #                     if dad.level == i.level:
    #                         print(i.username)
    #                         dad.bonuscoin += (10 / 100) * i.bonuscoin
    #                         dad.save()
    #                         if dad.referrer_temporary is not  None:
    #                             ax=User.objects.get(code=dad.referrer_temporary)
    #                             if ax.level == dad.level:
...
def check():
    ...
    a.reverse()
        # for i in ur
    # sorted((time.strptime(d, "%H:%M:%S") for d in ur.create_at), reverse=True)
    for i in a:
        print(i.create_at)
# schedule.every(1).seconds.do(autocheck)
# while True:
